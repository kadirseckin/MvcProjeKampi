    ...
    public class WriterValidator : AbstractValidator<Writer>
    {
        public WriterValidator()
        {
            ...
            RuleFor(x => x.WriterPassword).NotEmpty().
               WithMessage("Şifre kısmını boş geçemezsiniz");
            RuleFor(x => x.WriterMail).NotEmpty().
               WithMessage("Email kısmını boş geçemezsiniz");
            RuleFor(x => x.WriterTitle).NotEmpty().
                WithMessage("Yazar unvanını boş geçemezsiniz");
            ...
            RuleFor(x => x.WriterSurName).MaximumLength(50).
                 WithMessage("Lütfen 50 karakterden fazla karakter girişi yapmayın");
        }
    }
}
